...
namespace Tokket.Core
{
    ...
    public class TokkepediaUserAnalyticsReactionsReceived : BaseModel
    {
        private const string _serviceId = "tokkepedia";

        /// <summary>Type of document.</summary>
        [JsonProperty("label")]
        public string Label { get; set; } = $"{_serviceId}useranalyticsreactionsreceived";
    ...
    public class UserAnalyticsReactionReceived : BaseModel
    {
