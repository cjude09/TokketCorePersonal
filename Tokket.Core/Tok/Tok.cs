...
namespace Tokket.Core
{
    ...
    public class Tok : BaseModel
    {
        ...
        /// <summary>Each tokmoji needs to be connected to a valid purchase. (Secondary Field, basic toks)</summary>
        ...
        /// <summary>Order of bullets to show for "number" and "letter". Options: null / "ascending" which is A-J or 1-10, "descending" which is J-A or 10-1 (Depending on how many details total)</summary>
        [JsonProperty(PropertyName = "bullet_order", NullValueHandling = NullValueHandling.Ignore)]
        public string BulletOrder { get; set; } = null;
        #endregion
        ...
        #region Indented Details
        /// <summary>Indents the detail - detailed toks only.</summary>
        ...
        /// <summary>Star rating average. Max is 5.0, min is 1.0</summary>
