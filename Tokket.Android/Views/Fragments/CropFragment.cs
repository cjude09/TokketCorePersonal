...
namespace Tokket.Android.Fragments
{
    public class CropFragment : AndroidX.Fragment.App.Fragment, CropImageView.IOnSetImageUriCompleteListener, CropImageView.IOnCropImageCompleteListener
    {
         ...
         */
        public void setImageUri(NetUri imageUri)
        {
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            if (savedInstanceState == null)
            {
                ...
                var imageUri = NetUri.Parse(Settings.ImageBrowseCrop);
                _cropImageView.SetImageUriAsync(imageUri);
            }
        }
        ...
        public void OnSetImageUriComplete(CropImageView view, NetUri uri, Java.Lang.Exception error)
        {
            if (error == null)
            {
