...
{
    public class StudySetsFragment : AndroidX.Fragment.App.Fragment
    {
        internal static StudySetsFragment Instance { get; private set; }
        ...
        public StudySetsFragment(string _groupId)
        {
            groupId = _groupId;
        }
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            var v = inflater.Inflate(Resource.Layout.studysets_toksets_page, container, false);
            page = v;
            Instance = this;
            ...
            refreshLayout = v.FindViewById<SwipeRefreshLayout>(Resource.Id.studysets_mytoksets_swiperefresh);
        ...
        public ProgressBar bottomProgress => page.FindViewById<ProgressBar>(Resource.Id.studysets_bottomProgress);
        public RecyclerView RecyclerMainList => page.FindViewById<RecyclerView>(Resource.Id.recyclerView_studysets);
        public ShimmerLayout ShimmerLayout => page.FindViewById<ShimmerLayout>(Resource.Id.studysets_shimmer_view_container);
