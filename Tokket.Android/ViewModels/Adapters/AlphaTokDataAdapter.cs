...
{
    public class AlphaTokDataAdapter : RecyclerView.Adapter, View.IOnTouchListener// View.IOnLongClickListener
    {
        ...
        #endregion
        #region Constructor
        public AlphaTokDataAdapter(List<TokModel> _items, List<Tokmoji> _listTokMoji) //If caller is Activity or Fragment
        {
            items = _items;
        ...
        public void UpdateItems(List<TokModel> listUpdate, int position)
        {
