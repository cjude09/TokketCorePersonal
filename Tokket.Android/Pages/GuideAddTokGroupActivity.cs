...
namespace Tokket.Android
{
    ...
    public class GuideAddTokGroupActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_guide_add_tok_group);
        ...
        {
            GuideAddTokGroupActivity activity;
            public GuidelineAnimation(GuideAddTokGroupActivity _activity)
            {
                activity = _activity;
            }
        ...
        {
            private GuideAddTokGroupActivity activity;
            public MyGestureListener(GuideAddTokGroupActivity Activity)
            {
                activity = Activity;
            }
