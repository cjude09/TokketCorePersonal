...
{
    public class InfiniteCirclePageIndicator : View, LoopingPageIndicator
    {
        ...
        private LoopingViewPager.IOnPageChangeListener mListener;
        ...
        public InfiniteCirclePageIndicator(Context context) : this(context, null)
        {
        }

        public InfiniteCirclePageIndicator(Context context, IAttributeSet attrs) : this(context, attrs, Resource.Attribute.vpiCirclePageIndicatorStyle)
        {
        }

        public InfiniteCirclePageIndicator(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
            ...
            mPaintTransparent = new Paint(PaintFlags.AntiAlias);
            mPaintTransparent.SetStyle(Paint.Style.Fill);
            mPaintTransparent.Color = Color.Transparent;
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            for (int iLoop = 0; iLoop < count; iLoop++)
            {
                ...
                if (iLoop == 0 || iLoop == (count - 1))
                {
                    ...
                    {
                        canvas.DrawCircle(dX, dY, pageFillRadius, mPaintTransparent);
                    }

                    // Only paint stroke if a stroke width was non-zero
                    if (pageFillRadius != mRadius)
                    {
                        canvas.DrawCircle(dX, dY, mRadius, mPaintTransparent);
                    }
                }
                else
                {
        ...
        public void SetViewPager(LoopingViewPager view)
        {
        ...
        public void SetViewPager(LoopingViewPager view, int initialPosition)
        {
            SetViewPager(view);
        ...
        public void SetOnPageChangeListener(LoopingViewPager.IOnPageChangeListener listener)
        {
            mListener = listener;
        }
