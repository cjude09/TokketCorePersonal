...
namespace Tokket.Shared.Models.Tokquest
{
    public class ClassGroup : BaseModel
    {
        ...
        // This will only be set based on the user who logged in
        ...
        //  <summary>Needed for fast rendering of class group page</summary>
        ...
        [JsonProperty(PropertyName = "color_number", NullValueHandling = NullValueHandling.Ignore)]
        public string ColorNumber { get; set; } = "0";
        #endregion
    }
}
